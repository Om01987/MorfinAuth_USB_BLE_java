...
public class BleActionAdapter extends RecyclerView.Adapter<BleActionAdapter.MyViewHolder> {

    private ArrayList<NavigationMenuItem> menuItemArrayList;
    private Context act;
    BleActionClickListener itemClickListener;

    public BleActionAdapter(Context mainActivity, ArrayList<NavigationMenuItem> navigationMenuItemArrayList,
                            BleActionClickListener itemClickListener) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.rel_item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                itemClickListener.onBleActionClick(clickedPosition, data.menu_name);
            }
        });
    }


    public interface BleActionClickListener {
        void onBleActionClick(int position, String item_name);
    }
